...
namespace FronkonGames.Retro.OldFilms
{
  ...
  public sealed class SupportWindow : EditorWindow
  {
    ...
    [MenuItem("Help/Fronkon Games/Retro/Old Films/Online documentation")]
    public static void OnlineDocumentation() => Application.OpenURL(Constants.Support.Documentation);

    [MenuItem("Help/Fronkon Games/Retro/Old Films/Leave a review ❤️")]
    public static void LeaveAReview() => Application.OpenURL(Constants.Support.Store);

    [MenuItem("Help/Fronkon Games/Retro/Old Films/Support && suggestions")]
